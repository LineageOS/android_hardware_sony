...
Return<bool> HighTouchPollingRate::isEnabled() {
    ...
    auto result = sscanf(i.c_str(), "get_stamina_mode:%d", &stamina_mode);
...
Return<bool> HighTouchPollingRate::setEnabled(bool enabled) {
    auto device_name = android::base::GetProperty("ro.product.system.device", "unknown");
    auto is_low_rate_device = device_name == "pdx203";
