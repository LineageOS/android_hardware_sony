...
INSTANTIATE_TEST_CASE_P(
        HwApiTests, GetUint32Test,
        ValuesIn({
                GetUint32Test::MakeParam("device/num_waves", &Vibrator::HwApi::getEffectCount),
...
INSTANTIATE_TEST_CASE_P(HwApiTests, SetStringTest,
                        ValuesIn({
                                ...
                                SetStringTest::MakeParam("device/pwle", &Vibrator::HwApi::setPwle),
                        }),
