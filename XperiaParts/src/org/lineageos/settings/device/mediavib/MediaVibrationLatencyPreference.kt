...
class MediaVibrationLatencyPreference(context: Context) : Preference(context), SeekBar.OnSeekBarChangeListener {
    private lateinit var mLatencyValue : TextView
    private lateinit var mLatencyBar: SeekBar

    init {
        setLayoutResource(R.layout.preference_media_vibration_latency)
    }
    ...
    override fun onProgressChanged(seekBar: SeekBar?, progress: Int, fromUser: Boolean) {
        mLatencyValue.text = String.format("utf-8", "%d", progress)
    }
